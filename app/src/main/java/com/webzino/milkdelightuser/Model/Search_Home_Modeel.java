...
public class Search_Home_Modeel {

    String product_id, subcat_id, product_name, mrp, price, subscription_price, qty, product_image, description,

    stock, unit, created_at,updated_at, category_id, subcat_name, subcat_image, cityadmin_id, category_name, category_image;
