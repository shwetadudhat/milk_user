...
public class Showsubscrip_Model {

    String product_name, product_image, subs_id, delivery_date, order_qty, price, start_date,
    productid,plan_id,
            description,unit , sub_status,skip_days , plans , qty,subprice;
    String image,strat_date,end_date,orderId;


    public Showsubscrip_Model() {
