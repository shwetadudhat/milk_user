...
public class FilterProduct extends BaseActivity implements AdapterView.OnItemClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ll_clear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                adapter = new ArrayAdapter<String>(FilterProduct.this,
                        android.R.layout.simple_dropdown_item_1line, sort_type);
                edSortType.setAdapter(adapter);
                editor.clear().apply();
        ...
        CustomVolleyJsonRequest jsonObjectRequest = new CustomVolleyJsonRequest( BaseURL.product_size, params, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    Toast.makeText(FilterProduct.this, message, Toast.LENGTH_SHORT).show();

                    if (status.equals("1")){
                        JSONArray jsonArray = response.getJSONArray("data");
                        if (jsonArray.length()==0){
                            Toast.makeText(FilterProduct.this, "0 data found", Toast.LENGTH_SHORT).show();
