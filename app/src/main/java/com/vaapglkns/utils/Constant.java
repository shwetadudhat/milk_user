...
public class Constant {
    public static final String FOLDER_NAME = ".vaapglkns";
    public static final String CACHE_DIR = ".vaapglkns/Cache";
    ...
    public static final int REQUEST_PERMISSION = 8810;
    public static final int REQUEST_GPS = 8811;

    //FOR BUNDLE PARAMETERS
    public static final String bURL = "url";
