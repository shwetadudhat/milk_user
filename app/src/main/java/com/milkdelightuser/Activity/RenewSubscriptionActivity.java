...
public class RenewSubscriptionActivity extends BaseActivity {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (status.equals("1")){
                        ...
                        Toast.makeText(RenewSubscriptionActivity.this, message, Toast.LENGTH_SHORT).show();
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (status.equals("1")){
                        ...
                        /*Glide.with(RenewSubscriptionActivity.this)
                                .load(proImgae)
                                .into(ivproImage);*/

                        Global.loadGlideImage(RenewSubscriptionActivity.this,proImgae,proImgae,ivproImage);
    ...
    private void getPlanadata() {
        ...
        CustomVolleyJsonRequest jsonObjectRequest = new CustomVolleyJsonRequest( BaseURL.subscription_plans_list, params, new Response.Listener<JSONObject>() {
                ...
                try {
                    ...
                    if (status.equals("1")){
                        ...
                        if (jsonArray.length()==0){
                            Toast.makeText(RenewSubscriptionActivity.this, "0 data found", Toast.LENGTH_SHORT).show();
                        }else{
                            ...
                            adapterFreqPlan=new Adapter_FreqPlan(RenewSubscriptionActivity.this,planModelList);
            ...
            public void onErrorResponse(VolleyError error) {
                Log.e("error1234",error.toString());
                dismissDialog();
                //   Toast.makeText(RenewSubscriptionActivity.this, "" + error, Toast.LENGTH_SHORT).show();
            }
        });
