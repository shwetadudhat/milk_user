...
public class Completed_Model {

    String product_id, subcat_id, product_name, price, subscription_price, qty, product_image, description, stock, unit,
            created_at, updated_at,mrp,home,delivery_date,cityadmin_name,city_name,order_qty,order_type,delivery_boy_name,delivery_boy_id,
            category_id, subcat_name, subcat_image, cityadmin_id, category_name, category_image;
    ...
    public String getCityadmin_name() {
        return cityadmin_name;
    }

    public void setCityadmin_name(String cityadmin_name) {
        this.cityadmin_name = cityadmin_name;
    }
